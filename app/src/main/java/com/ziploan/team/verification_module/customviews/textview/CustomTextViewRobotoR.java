 ...
 */
public class CustomTextViewRobotoR extends TextView {
    private final Context mContext;

    public CustomTextViewRobotoR(Context context) {
        this(context,null);
        setTypeface(null);
    }

    public CustomTextViewRobotoR(Context context, AttributeSet attrs) {
        this(context, attrs,0);
        setTypeface(null);
    }

    public CustomTextViewRobotoR(Context context, AttributeSet attrs, int defStyleAttr) {
